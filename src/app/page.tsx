...
export default function LandingPage() {
  ...
  <div id="social-proof" data-section="social-proof">
      ...
      useInvertedBackground={false}
      names={["Nexus", "CoreTech", "Orbit", "Vertex", "Pulse", "Zenith", "Flux"]}
      logos={["http://img.b2bpic.net/free-vector/gradient-advertising-agency-logo-design_23-2149995841.jpg", "http://img.b2bpic.net/free-vector/photo-logostype_1057-4485.jpg", "http://img.b2bpic.net/free-vector/plumber-services-logo-design-template_742173-26558.jpg", "http://img.b2bpic.net/free-vector/technology-logo-template_23-2150529469.jpg", "http://img.b2bpic.net/free-vector/modern-abstract-colorful-geometry_530521-1395.jpg", "http://img.b2bpic.net/free-vector/business-people-3-flat-banners-set_1284-7442.jpg", "http://img.b2bpic.net/free-vector/technical-logo-design_1424-40.jpg"]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        {
          id: "3",          title: "Future of Retail",          quote: "Stunning interface and performance.",          name: "Emma",          role: "Manager",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BXXuZmK7jhnimueMVZmKhqM6CC/professional-portrait-soft-studio-light--1774636692244-eb26ae7f.png"
        },
        {
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",          title: "What file types are supported?",          content: "We support GLB and GLTF."
        },
        {
          id: "q2",          title: "Is the site mobile friendly?",          content: "Yes, fully optimized for all devices."
        },
        {
          id: "q3",          title: "How do payments work?",          content: "Stripe/Razorpay integrated."
        }
      ]}
